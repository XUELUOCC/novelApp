<template>
    <div class="containerBoyBook">
        ...
        <div class="bookGuru">
            ...
            <van-grid-item v-for="(item,index) in concentrationList" :key="item.index" @click="getBookDetail(index)">
                <van-badge >
        ...
        <div class="XuanHuanBook">
         ...
         <div class="systemBook">
            ...
            <div class="systemBookList">
              ...
              finished-text=""
              @load="onLoadX">
                <div class="bookInfo" v-for="(item,index) in systemBookList" :key="item.index" @click="getCityBook(index)">
                  <div class="infoLeft">
                    <img src="../../assets/bookShelf/novelPage.jpg" alt="">
                  </div>
                  <div class="infoRight">
